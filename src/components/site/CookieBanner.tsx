...
/**
 * Read the stored consent (or null if never set).
 */
...
function writeConsent(c: Omit<Consent, "essential" | "setAt">) {
  ...
  // Surface for tag managers / analytics scripts to gate on
        ...
        <div className="mt-4 flex flex-wrap items-center gap-2">
          {!showPrefs ? (
            <>
              ...
              <Button size="md" variant="secondary" onClick={rejectAll}>
                Reject all
              </Button>
              <button
                type="button"
            ...
            <>
              <Button size="md" onClick={savePrefs}>
                Save preferences
              </Button>
              <Button size="md" variant="secondary" onClick={rejectAll}>
                Reject all
